...
`
        ...
        await transporter.sendMail({
          ...
          text: emailBody,
          html: `
<div style="font-family: monospace; max-width: 600px; margin: 0 auto; padding: 20px; background: #0a0a0a; border: 1px solid #333; border-radius: 8px;">
  ...
  <div style="border-left: 3px solid #00ff88; padding-left: 16px; margin-bottom: 20px;">
    <p style="color: #ccc;"><strong style="color: #fff;">👤 Name:</strong> ${name.trim()}</p>
    <p style="color: #ccc;"><strong style="color: #fff;">📞 Phone:</strong> ${phone.trim()}</p>
    <p style="color: #ccc;"><strong style="color: #fff;">📧 Email:</strong> ${email.trim()}</p>
  </div>
...
`,
        ...
        console.error('SMTP email failed, but contact was saved:', emailError)
      }
    }
